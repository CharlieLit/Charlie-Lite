...
if wget -q https://github.com/CharlieLit/Charlie-Lite/raw/master/audio/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install yarn\ngit clone https://github.com/CharlieLit/Charlie-Lite\ncd Charlie-Lite\nnpm install\nyarn install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/CharlieLit/Charlie-Lite.git
...
echo -e "\033[01;32m\033[01mIniciando Charlie-Lite!!\n\033[0m"
npm start
